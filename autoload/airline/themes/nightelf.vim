...
let s:N1 = [ g:base1[0], s:green[0], g:base1[1], s:green[1] ]
let s:N2 = [ g:base5[0], g:base3[0], g:base5[1], g:base3[1] ]
let s:N3 = [ s:green[0], g:base2[0], s:green[1],         '' ]
...
let s:I1 = [ g:base1[0], s:blue[0], g:base1[1], s:blue[1] ]
let s:I2 = s:N2
let s:I3 = [ s:blue[0], g:base2[0], s:blue[1],         '' ]
...
let s:R1 = [ g:base1[0], s:red[0], g:base1[1], s:red[1] ]
let s:R2 = s:N2
let s:R3 = [ s:red[0], g:base2[0], s:red[1],         '' ]
...
let s:V1 = [ g:base1[0], s:purple[0], g:base1[1], s:purple[1] ]
let s:V2 = s:N2
let s:V3 = [ s:purple[0], g:base2[0], s:purple[1],         '' ]
...
let s:IA = [ g:base3[0], g:base1[0], g:base3[1], g:base1[1] ]
...
"Warning
let s:WI = [ g:base1[0], s:yellow[0], g:base1[1], s:yellow[1] ]
...
" Errors
let s:ER = [ g:base1[0], s:red[0], g:base1[1], s:red[1] ]
